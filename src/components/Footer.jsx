            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-6 text-sm text-gray-400 mb-6 md:mb-0">
              <a className="group relative hover:text-white transition-colors duration-300">
                ...
                >
                  ...
                  personal data. We collect only the information needed to power
                  your job search—such as your profile, applications, and saved
                  jobs—and never sell it to third parties. You stay in control
                  of your data and can update or remove it at any time.
              ...
              <a className="group relative hover:text-white transition-colors duration-300">
                ...
                >
                  ...
                  provide accurate information. Job postings and applications
                  must not be misleading or fraudulent. We may suspend accounts
                  that violate these terms. JobPortal is provided "as is"
                  without warranties, and we are not liable for hiring decisions
                  made between employers and candidates.
                  <span className="absolute top-full left-1/2 -translate-x-1/2 w-0 h-0 border-x-8 border-x-transparent border-t-8 border-t-gray-800"></span>
                </div>
              </a>
              <a className="group relative hover:text-white transition-colors duration-300">
                ...
                >
                  ...
                  site traffic, and remember your preferences. Essential cookies
                  keep you signed in and store your saved jobs; analytics
                  cookies help us improve the portal. By using JobPortal, you
